...
ALTER TABLE `ReplacementRequest`
    ADD CONSTRAINT `ReplacementRequest_tenantId_fkey`
    FOREIGN KEY (`tenantId`)
    REFERENCES `Tenant`(`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `ReplacementRequest`
    ADD CONSTRAINT `ReplacementRequest_originalRespondentId_fkey`
    FOREIGN KEY (`originalRespondentId`)
...
-- AddForeignKey
ALTER TABLE `ReplacementRequest`
    ADD CONSTRAINT `ReplacementRequest_candidateRespondentId_fkey`
    FOREIGN KEY (`candidateRespondentId`)
    REFERENCES `Beneficiary`(`id`)
    ON DELETE SET NULL
    ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `ReplacementRequest`
    ADD CONSTRAINT `ReplacementRequest_requestedByUserId_fkey`
...
-- AddForeignKey
ALTER TABLE `ReplacementRequest`
    ADD CONSTRAINT `ReplacementRequest_decidedByUserId_fkey`
...
ALTER TABLE `FieldCheckIn`
    ADD CONSTRAINT `FieldCheckIn_tenantId_fkey`
    FOREIGN KEY (`tenantId`)
    REFERENCES `Tenant`(`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `FieldCheckIn`
    ADD CONSTRAINT `FieldCheckIn_userId_fkey`
    FOREIGN KEY (`userId`)
    REFERENCES `User`(`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `FieldCheckIn`
    ADD CONSTRAINT `FieldCheckIn_projectId_fkey`
