...
import availabilityCheckRoutes from "./routes/availabilityCheckRoutes.js";
...
import programTeamRoutes from "./routes/programTeamRoutes.js";
...
export function createApp() {
  ...
  app.use("/api/program-teams", programTeamRoutes);
  app.use("/api/beneficiary-assignments", beneficiaryAssignmentRoutes);
  app.use("/api/availability-checks", availabilityCheckRoutes);
